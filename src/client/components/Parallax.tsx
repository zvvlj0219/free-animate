...
const ParallaxContainer = ({ textData, imageData, theme,containerStyle }: Props) => {
    ...
    return (
      ...
      >
        <Parallax ref={parallax} pages={3} className='parallax' style={sampleContainerStyle}>
            <ParallaxLayer 
            ...
            >
                ...
                >
                    <div>
                        <img src={ts} style={sampleImageStyle} />
                    </div>
                </ParallaxLayer>
            </ParallaxLayer>
        </Parallax>
